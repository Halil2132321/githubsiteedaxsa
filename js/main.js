...
* ---------------------------*/
	...
	* ---------------------------*/
	...
	$(document).ready(function() {
		var siteHeader  = $('.crumina-stunning-header');
		var video = $('#myVideo');
	
		console.log(siteHeader.outerHeight(true))
		console.log(siteHeader.outerHeight())
		video[0].style.setProperty('height', `476px`, 'important');
	
		$(window).resize(function() {
			video[0].style.setProperty('height', `${siteHeader.outerHeight(true)}px`, 'important');
		});
	})
})(jQuery);